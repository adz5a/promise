(function () {
    ...
    function resolvePromise ( promise, value ) {
        ...
        var
            ...
            executedSynchronously = { "true": false },
            then;
            ...
            try {
                ...
                if ( typeof then === "function" ) {
                    ...
                    then.call( value, function ( v ) {
                        if ( executedSynchronously.true ) return;
                        executedSynchronously.true = true;
                ...
                if ( !executedSynchronously.true ) return transitionTo( promise, REJECTED, err );
            }
