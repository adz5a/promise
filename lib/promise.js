    ...
    function resolvePromise ( promise, value ) {
        ...
        if ( (valType === "object" || valType === "function") && value !== null ) {
            ...
            try {
                ...
                if ( cb[2].first ) return transitionTo( promise, REJECTED, err );//reject only if no callbacks were called
            }

        }
        if ( !resolvedAsync ) return transitionTo( promise, FULFILLED, value ); //accept if value is neither is not null
    }
